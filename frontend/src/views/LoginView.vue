<template>
  <div>
    <section class="text-center container pt-5">
      <img style="height:15rem; width:auto; padding-top:15px;" src="@/assets/Login.png" alt="">
    </section>
      ...
      <div class="login-page">
        <div class="form">
          <form @submit.prevent="login(credentials)" class="login-form">
            <input v-model="credentials.username" type="text" placeholder="username" required autofocus>
